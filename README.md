...
- [GitHub](https://github.com/deepmodeling/deepmd-kit) (👨‍💻 85 · 🔀 590 · 📥 71K · 📦 50 · 📋 1K - 10% open · ⏱️ 19.05.2026):

	```
	git clone https://github.com/deepmodeling/deepmd-kit
	```
- [PyPi](https://pypi.org/project/deepmd-kit) (📥 9.9K / month):
	```
...
- [GitHub](https://github.com/deepmodeling/abacus-develop) (👨‍💻 150 · 🔀 220 · 📋 2.6K - 7% open · ⏱️ 21.05.2026):

	```
	git clone https://github.com/deepmodeling/abacus-develop
	```
- [Conda](https://anaconda.org/conda-forge/abacus) (📥 660K · ⏱️ 20.12.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 68 · 🔀 150 · 📦 160 · 📋 140 - 19% open · ⏱️ 07.05.2026):

	```
	git clone https://github.com/deepmodeling/dpdata
	```
- [PyPi](https://pypi.org/project/dpdata) (📥 46K / month):
	```
	pip install dpdata
	```
...
- [GitHub](https://github.com/deepmodeling/dpgen) (👨‍💻 74 · 🔀 180 · 📥 2.1K · 📦 8 · 📋 340 - 11% open · ⏱️ 12.05.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpgen) (📥 690 / month):
	```
	pip install dpgen
	```
...
- [GitHub](https://github.com/deepmodeling/dpdispatcher) (👨‍💻 50 · 🔀 58 · 📦 70 · 📋 100 - 20% open · ⏱️ 13.05.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpdispatcher) (📥 4K / month):
	```
...
- [GitHub](https://github.com/deepmodeling/reacnetgenerator) (👨‍💻 20 · 🔀 45 · 📦 3 · 📋 130 - 6% open · ⏱️ 15.05.2026):
...
- [PyPi](https://pypi.org/project/reacnetgenerator) (📥 1.5K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/reacnetgenerator) (📥 780K · ⏱️ 11.11.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/dargs) (👨‍💻 8 · 🔀 4 · 📦 160 · 📋 14 - 21% open · ⏱️ 24.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/dargs) (📥 56K / month):
	```
	pip install dargs
	```
- [Conda](https://anaconda.org/conda-forge/dargs) (📥 66K · ⏱️ 25.02.2026):
	```
	conda install -c conda-forge dargs
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/jax-fem">JAX-FEM</a></b> (🥈16 ·  ⭐ 680 · 📈) - Differentiable Finite Element Method with JAX. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/jax-fem) (👨‍💻 17 · 🔀 120 · 📦 4 · 📋 74 - 28% open · ⏱️ 21.05.2026):
...
- [GitHub](https://github.com/deepmodeling/DeePTB) (👨‍💻 15 · 🔀 30 · 📦 4 · 📋 63 - 33% open · ⏱️ 19.05.2026):
...
- [GitHub](https://github.com/deepmodeling/dpgen2) (👨‍💻 19 · 🔀 36 · 📦 6 · 📋 46 - 39% open · ⏱️ 06.05.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpgen2) (📥 81 / month):
	```
	pip install dpgen2
	```
...
- [GitHub](https://github.com/deepmodeling/APEX) (👨‍💻 7 · 🔀 27 · 📦 4 · 📋 10 - 10% open · ⏱️ 10.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/apex-flow) (📥 160 / month):
	```
...
- [GitHub](https://github.com/deepmodeling/dpgui) (👨‍💻 4 · 🔀 5 · 📦 13 · ⏱️ 26.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/dpgui) (📥 40K / month):
	```
	pip install dpgui
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/dpti) (👨‍💻 17 · 🔀 23 · 📦 2 · 📋 10 - 90% open · ⏱️ 12.05.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpti) (📥 24 / month):
	```
	pip install dpti
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/fealpy) (👨‍💻 69 · 🔀 2 · ⏱️ 28.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/fealpy) (📥 200 / month):
	```
	pip install fealpy
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/AIS-Square) (👨‍💻 8 · 🔀 9 · 📋 6 - 83% open · ⏱️ 04.05.2026):
