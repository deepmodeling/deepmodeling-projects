...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 67 · 🔀 150 · 📦 160 · 📋 140 - 21% open · ⏱️ 24.03.2026):

	```
	git clone https://github.com/deepmodeling/dpdata
	```
- [PyPi](https://pypi.org/project/dpdata) (📥 77K / month):
	```
	pip install dpdata
	```
...
- [GitHub](https://github.com/deepmodeling/abacus-develop) (👨‍💻 140 · 🔀 200 · 📋 2.5K - 7% open · ⏱️ 24.03.2026):

	```
	git clone https://github.com/deepmodeling/abacus-develop
	```
- [Conda](https://anaconda.org/conda-forge/abacus) (📥 620K · ⏱️ 20.12.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/dpdispatcher) (👨‍💻 49 · 🔀 58 · 📦 70 · 📋 99 - 19% open · ⏱️ 25.03.2026):
...
- [GitHub](https://github.com/deepmodeling/reacnetgenerator) (👨‍💻 19 · 🔀 45 · 📦 3 · 📋 130 - 6% open · ⏱️ 15.03.2026):
...
- [PyPi](https://pypi.org/project/dargs) (📥 88K / month):
	...
	pip install dargs
	```
- [Conda](https://anaconda.org/conda-forge/dargs) (📥 62K · ⏱️ 25.02.2026):
	```
	conda install -c conda-forge dargs
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/deepflame-dev">DeepFlame</a></b> (🥈17 ·  ⭐ 210) - A deep learning empowered open-source platform for reacting flow simulations. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/deepmodeling/dpgen2) (👨‍💻 19 · 🔀 36 · 📦 6 · 📋 46 - 39% open · ⏱️ 11.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpgen2) (📥 87 / month):
	```
	pip install dpgen2
	```
...
- [GitHub](https://github.com/deepmodeling/dpgui) (👨‍💻 4 · 🔀 5 · 📦 13 · ⏱️ 26.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/dpgui) (📥 76K / month):
	```
	pip install dpgui
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/jax-fem">JAX-FEM</a></b> (🥈14 ·  ⭐ 620) - Differentiable Finite Element Method with JAX. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/jax-fem) (👨‍💻 17 · 🔀 100 · 📦 3 · 📋 71 - 35% open · ⏱️ 08.02.2026):

	```
	git clone https://github.com/deepmodeling/jax-fem
	```
- [PyPi](https://pypi.org/project/jax-fem) (📥 550 / month):
	```
	pip install jax-fem
	```
</details>
...
<details><summary><b><a href="https://github.com/deepmodeling/APEX">APEX</a></b> (🥈13 ·  ⭐ 44 · 💤) - APEX: Alloy Properties EXplorer using simulations. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/deepmodeling/rid-kit) (👨‍💻 14 · 🔀 25 · 📥 150 · 📦 2 · 📋 5 - 40% open · ⏱️ 31.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/rid-kit) (📥 46 / month):
	```
	pip install rid-kit
	```
</details>
...
<details><summary><b><a href="https://github.com/deepmodeling/dpti">dpti</a></b> (🥉10 ·  ⭐ 33 · 💤) - A Python Package to Automate Thermodynamic Integration Calculations for Free Energy. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/dpti) (👨‍💻 17 · 🔀 23 · 📋 10 - 90% open · ⏱️ 15.03.2025):
...
- [GitHub](https://github.com/deepmodeling/fealpy) (👨‍💻 69 · 🔀 2 · ⏱️ 28.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/fealpy) (📥 560 / month):
	```
	pip install fealpy
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/args) (👨‍💻 3 · 🔀 2 · 📦 5 · ⏱️ 15.12.2025):
	...
	```
- [npm](https://www.npmjs.com/package/@deepmodeling/args) (📥 45 / month):
	```
...
- [GitHub](https://github.com/deepmodeling/Uni-Fold) (👨‍💻 3 · 🔀 19 · ⏱️ 18.08.2022):
	...
	```
- [Docker Hub](https://hub.docker.com/r/dptechnology/unifold) (📥 1.4K · ⏱️ 08.01.2024):
	```
...
<details><summary><b><a href="https://github.com/deepmodeling/tbplas">tbplas</a></b> (🥉6 ·  ⭐ 15 · 💤) - Repository of TBPLaS (tight-binding package for large-scale simulation). <code>Unlicensed</code></summary>
