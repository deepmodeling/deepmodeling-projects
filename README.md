...
- [GitHub](https://github.com/deepmodeling/deepmd-kit) (👨‍💻 84 · 🔀 570 · 📥 68K · 📦 46 · 📋 980 - 9% open · ⏱️ 11.03.2026):

	```
	git clone https://github.com/deepmodeling/deepmd-kit
	```
- [PyPi](https://pypi.org/project/deepmd-kit) (📥 7.6K / month):
	```
...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 68 · 🔀 150 · 📦 160 · 📋 130 - 21% open · ⏱️ 11.03.2026):

	```
	git clone https://github.com/deepmodeling/dpdata
	```
- [PyPi](https://pypi.org/project/dpdata) (📥 75K / month):
	```
	pip install dpdata
	```
...
- [GitHub](https://github.com/deepmodeling/abacus-develop) (👨‍💻 140 · 🔀 150 · 📋 2.5K - 7% open · ⏱️ 12.03.2026):

	```
	git clone https://github.com/deepmodeling/abacus-develop
	```
- [Conda](https://anaconda.org/conda-forge/abacus) (📥 610K · ⏱️ 20.12.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/dpgen) (👨‍💻 73 · 🔀 180 · 📥 2.1K · 📦 8 · 📋 340 - 11% open · ⏱️ 01.03.2026):
...
- [PyPi](https://pypi.org/project/dpdispatcher) (📥 3.3K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dpdispatcher) (📥 41K · ⏱️ 25.02.2026):
	```
	conda install -c conda-forge dpdispatcher
	```
- [Docker Hub](https://hub.docker.com/r/dptechnology/dpdispatcher) (📥 150K · ⏱️ 25.02.2026):
	```
...
- [GitHub](https://github.com/deepmodeling/reacnetgenerator) (👨‍💻 19 · 🔀 44 · 📦 3 · 📋 130 - 6% open · ⏱️ 24.02.2026):
...
- [PyPi](https://pypi.org/project/reacnetgenerator) (📥 3.9K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/reacnetgenerator) (📥 750K · ⏱️ 11.11.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/dargs) (👨‍💻 8 · 🔀 4 · 📦 160 · 📋 14 - 21% open · ⏱️ 24.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/dargs) (📥 88K / month):
	```
	pip install dargs
	```
- [Conda](https://anaconda.org/conda-forge/dargs) (📥 61K · ⏱️ 25.02.2026):
	```
	conda install -c conda-forge dargs
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/dflow">dflow</a></b> (🥈18 ·  ⭐ 81) - Dflow is a Python framework for constructing scientific computing workflows (e.g. concurrent learning workflows).. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/deepmodeling/DeePTB) (👨‍💻 15 · 🔀 27 · 📦 4 · 📋 58 - 31% open · ⏱️ 11.03.2026):
...
- [PyPi](https://pypi.org/project/dpgen2) (📥 73 / month):
	...
	pip install dpgen2
	```
- [Docker Hub](https://hub.docker.com/r/dptechnology/dpgen2) (📥 4.4K · ⏱️ 11.03.2026):
	```
...
- [GitHub](https://github.com/deepmodeling/dpgui) (👨‍💻 4 · 🔀 5 · 📦 13 · ⏱️ 26.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/dpgui) (📥 74K / month):
	```
	pip install dpgui
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/jax-fem">JAX-FEM</a></b> (🥈14 ·  ⭐ 600) - Differentiable Finite Element Method with JAX. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/jax-fem) (👨‍💻 17 · 🔀 98 · 📦 3 · 📋 70 - 34% open · ⏱️ 08.02.2026):

	```
	git clone https://github.com/deepmodeling/jax-fem
	```
- [PyPi](https://pypi.org/project/jax-fem) (📥 640 / month):
	```
	pip install jax-fem
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/APEX) (👨‍💻 7 · 🔀 27 · 📦 4 · 📋 10 - 10% open · ⏱️ 10.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/apex-flow) (📥 370 / month):
	```
...
- [GitHub](https://github.com/deepmodeling/GPUMD) (👨‍💻 57 · ⏱️ 12.03.2026):
...
<details><summary><b><a href="https://github.com/deepmodeling/dpti">dpti</a></b> (🥉10 ·  ⭐ 32 · 💤) - A Python Package to Automate Thermodynamic Integration Calculations for Free Energy. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/deepmodeling/dpti) (👨‍💻 17 · 🔀 22 · 📦 2 · 📋 10 - 90% open · ⏱️ 15.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/dpti) (📥 36 / month):
	```
	pip install dpti
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/AIS-Square) (👨‍💻 8 · 🔀 8 · 📋 6 - 83% open · ⏱️ 05.03.2026):
...
- [GitHub](https://github.com/deepmodeling/fpop) (👨‍💻 4 · 🔀 12 · 📦 15 · ⏱️ 01.07.2024):
	...
	```
- [PyPi](https://pypi.org/project/fpop) (📥 290 / month):
	```
	pip install fpop
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/args) (👨‍💻 3 · 🔀 2 · 📦 5 · ⏱️ 15.12.2025):
	...
	```
- [npm](https://www.npmjs.com/package/@deepmodeling/args) (📥 80 / month):
	```
...
- [GitHub](https://github.com/deepmodeling/Uni-Fold) (👨‍💻 3 · 🔀 19 · ⏱️ 18.08.2022):
	...
	```
- [Docker Hub](https://hub.docker.com/r/dptechnology/unifold) (📥 1.3K · ⏱️ 08.01.2024):
	```
