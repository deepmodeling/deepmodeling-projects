...
- [GitHub](https://github.com/deepmodeling/deepmd-kit) (👨‍💻 85 · 🔀 590 · 📥 72K · 📦 53 · 📋 1K - 10% open · ⏱️ 18.06.2026):
...
- [GitHub](https://github.com/deepmodeling/abacus-develop) (👨‍💻 160 · 🔀 230 · 📋 2.6K - 7% open · ⏱️ 17.06.2026):

	```
	git clone https://github.com/deepmodeling/abacus-develop
	```
- [Conda](https://anaconda.org/conda-forge/abacus) (📥 690K · ⏱️ 20.12.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 68 · 🔀 150 · 📦 160 · 📋 140 - 20% open · ⏱️ 17.06.2026):

	```
	git clone https://github.com/deepmodeling/dpdata
	```
- [PyPi](https://pypi.org/project/dpdata) (📥 84K / month):
	```
	pip install dpdata
	```
...
- [GitHub](https://github.com/deepmodeling/dpgen) (👨‍💻 74 · 🔀 180 · 📥 2.1K · 📦 8 · 📋 340 - 11% open · ⏱️ 17.06.2026):

	```
	git clone https://github.com/deepmodeling/dpgen
	```
- [PyPi](https://pypi.org/project/dpgen) (📥 710 / month):
	```
	pip install dpgen
	```
...
- [GitHub](https://github.com/deepmodeling/dpdispatcher) (👨‍💻 50 · 🔀 58 · 📦 70 · 📋 100 - 19% open · ⏱️ 04.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpdispatcher) (📥 3.1K / month):
	```
...
- [GitHub](https://github.com/deepmodeling/reacnetgenerator) (👨‍💻 20 · 🔀 45 · 📦 3 · 📋 130 - 6% open · ⏱️ 27.05.2026):
	...
	```
- [PyPi](https://pypi.org/project/reacnetgenerator) (📥 2.7K / month):
	```
...
<details><summary><b><a href="https://github.com/deepmodeling/dpgen2">DPGEN2</a></b> (🥈18 ·  ⭐ 41 · 📈) - 2nd generation of the Deep Potential GENerator. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/dpgen2) (👨‍💻 19 · 🔀 36 · 📦 6 · 📋 48 - 37% open · ⏱️ 08.06.2026):
...
- [PyPi](https://pypi.org/project/dpgen2) (📥 94 / month):
	...
	pip install dpgen2
	```
- [Docker Hub](https://hub.docker.com/r/dptechnology/dpgen2) (📥 4.6K · ⏱️ 18.06.2026):
	```
...
- [GitHub](https://github.com/deepmodeling/dargs) (👨‍💻 8 · 🔀 4 · 📦 160 · 📋 14 - 21% open · ⏱️ 24.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/dargs) (📥 92K / month):
	```
	pip install dargs
	```
- [Conda](https://anaconda.org/conda-forge/dargs) (📥 68K · ⏱️ 25.02.2026):
	```
	conda install -c conda-forge dargs
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/jax-fem">JAX-FEM</a></b> (🥈16 ·  ⭐ 700) - Differentiable Finite Element Method with JAX. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/jax-fem) (👨‍💻 17 · 🔀 120 · 📦 4 · 📋 75 - 29% open · ⏱️ 13.06.2026):

	```
	git clone https://github.com/deepmodeling/jax-fem
	```
- [PyPi](https://pypi.org/project/jax-fem) (📥 1K / month):
	```
	pip install jax-fem
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/dflow">dflow</a></b> (🥈16 ·  ⭐ 81 · 📉) - Dflow is a Python framework for constructing scientific computing workflows (e.g. concurrent learning workflows).. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code></summary>
...
<details><summary><b><a href="https://github.com/deepmodeling/DeePTB">DeePTB</a></b> (🥈15 ·  ⭐ 120) - DeePTB: A deep learning package for tight-binding Hamiltonian with ab initio accuracy. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/deepmodeling/dpgui) (👨‍💻 4 · 🔀 5 · 📦 15 · ⏱️ 26.08.2025):

	```
	git clone https://github.com/deepmodeling/dpgui
	```
- [PyPi](https://pypi.org/project/dpgui) (📥 79K / month):
	```
	pip install dpgui
	```
</details>
...
<details><summary><b><a href="https://github.com/deepmodeling/dpti">dpti</a></b> (🥉11 ·  ⭐ 37) - A Python Package to Automate Thermodynamic Integration Calculations for Free Energy. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/dpti) (👨‍💻 17 · 🔀 23 · 📦 2 · 📋 10 - 90% open · ⏱️ 18.06.2026):
...
- [GitHub](https://github.com/deepmodeling/deepmodeling_sphinx) (👨‍💻 8 · 🔀 6 · ⏱️ 31.05.2026):
	...
	```
- [PyPi](https://pypi.org/project/deepmodeling_sphinx) (📥 4.6K / month):
	```
...
- [GitHub](https://github.com/deepmodeling/fpop) (👨‍💻 4 · 🔀 12 · 📦 18 · ⏱️ 01.07.2024):
	...
	```
- [PyPi](https://pypi.org/project/fpop) (📥 660 / month):
	```
	pip install fpop
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/AIS-Square) (👨‍💻 8 · 🔀 9 · 📋 6 - 83% open · ⏱️ 17.06.2026):
...
- [GitHub](https://github.com/deepmodeling/blog) (👨‍💻 11 · 🔀 9 · ⏱️ 18.06.2026):
