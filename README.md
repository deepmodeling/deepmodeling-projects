...
- [GitHub](https://github.com/deepmodeling/deepmd-kit) (👨‍💻 84 · 🔀 580 · 📥 71K · 📦 49 · 📋 1K - 10% open · ⏱️ 07.05.2026):
...
- [GitHub](https://github.com/deepmodeling/abacus-develop) (👨‍💻 150 · 🔀 220 · 📋 2.6K - 7% open · ⏱️ 07.05.2026):

	```
	git clone https://github.com/deepmodeling/abacus-develop
	```
- [Conda](https://anaconda.org/conda-forge/abacus) (📥 650K · ⏱️ 20.12.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 68 · 🔀 150 · 📦 160 · 📋 140 - 18% open · ⏱️ 07.05.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpdata) (📥 59K / month):
	```
	pip install dpdata
	```
- [Conda](https://anaconda.org/conda-forge/dpdata) (📥 130K · ⏱️ 01.03.2026):
	```
...
- [GitHub](https://github.com/deepmodeling/dpdispatcher) (👨‍💻 49 · 🔀 58 · 📦 70 · 📋 100 - 20% open · ⏱️ 10.04.2026):

	```
	git clone https://github.com/deepmodeling/dpdispatcher
	```
- [PyPi](https://pypi.org/project/dpdispatcher) (📥 3.8K / month):
	```
...
<details><summary><b><a href="https://github.com/deepmodeling/dpgen">DP-GEN</a></b> (🥈22 ·  ⭐ 390) - The deep potential generator to generate a deep-learning based model of interatomic potential energy and force field. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/deepmodeling/dpgen) (👨‍💻 73 · 🔀 180 · 📥 2.1K · 📦 8 · 📋 340 - 11% open · ⏱️ 15.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpgen) (📥 520 / month):
	```
	pip install dpgen
	```
...
- [GitHub](https://github.com/deepmodeling/reacnetgenerator) (👨‍💻 19 · 🔀 46 · 📦 3 · 📋 130 - 6% open · ⏱️ 15.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/reacnetgenerator) (📥 780 / month):
	```
	pip install reacnetgenerator
	```
- [Conda](https://anaconda.org/conda-forge/reacnetgenerator) (📥 770K · ⏱️ 11.11.2025):
	```
...
- [PyPi](https://pypi.org/project/dargs) (📥 67K / month):
	...
	pip install dargs
	```
- [Conda](https://anaconda.org/conda-forge/dargs) (📥 65K · ⏱️ 25.02.2026):
	```
...
<details><summary><b><a href="https://github.com/deepmodeling/jax-fem">JAX-FEM</a></b> (🥈16 ·  ⭐ 660 · 📈) - Differentiable Finite Element Method with JAX. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/deepmodeling/jax-fem) (👨‍💻 17 · 🔀 120 · 📦 4 · 📋 73 - 27% open · ⏱️ 05.05.2026):
	...
	```
- [PyPi](https://pypi.org/project/jax-fem) (📥 830 / month):
	```
	pip install jax-fem
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/deepflame-dev">DeepFlame</a></b> (🥈16 ·  ⭐ 210 · 📉) - A deep learning empowered open-source platform for reacting flow simulations. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/deepflame-dev) (👨‍💻 30 · 🔀 77 · 📋 63 - 41% open · ⏱️ 14.02.2026):
...
- [GitHub](https://github.com/deepmodeling/DeePTB) (👨‍💻 15 · 🔀 30 · 📦 4 · 📋 62 - 35% open · ⏱️ 05.05.2026):
...
- [GitHub](https://github.com/deepmodeling/dpgui) (👨‍💻 4 · 🔀 5 · 📦 13 · ⏱️ 26.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/dpgui) (📥 52K / month):
	```
	pip install dpgui
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/DMFF) (👨‍💻 17 · 🔀 48 · 📋 28 - 28% open · ⏱️ 07.04.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dmff) (📥 3.2K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/rid-kit) (👨‍💻 14 · 🔀 25 · 📥 150 · 📦 2 · 📋 5 - 40% open · ⏱️ 31.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/rid-kit) (📥 68 / month):
	```
	pip install rid-kit
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/dpti) (👨‍💻 17 · 🔀 23 · 📦 2 · 📋 10 - 90% open · ⏱️ 06.05.2026):
...
- [GitHub](https://github.com/deepmodeling/fealpy) (👨‍💻 69 · 🔀 2 · ⏱️ 28.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/fealpy) (📥 210 / month):
	```
	pip install fealpy
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/fpop) (👨‍💻 4 · 🔀 12 · 📦 15 · ⏱️ 01.07.2024):
	...
	```
- [PyPi](https://pypi.org/project/fpop) (📥 190 / month):
	```
	pip install fpop
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/args) (👨‍💻 3 · 🔀 2 · 📦 5 · ⏱️ 15.12.2025):
	...
	```
- [npm](https://www.npmjs.com/package/@deepmodeling/args) (📥 97 / month):
	```
