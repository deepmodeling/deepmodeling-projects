...
- [GitHub](https://github.com/deepmodeling/deepmd-kit) (👨‍💻 84 · 🔀 580 · 📥 70K · 📦 49 · 📋 1K - 10% open · ⏱️ 30.04.2026):
...
- [GitHub](https://github.com/deepmodeling/abacus-develop) (👨‍💻 150 · 🔀 220 · 📋 2.6K - 7% open · ⏱️ 30.04.2026):

	```
	git clone https://github.com/deepmodeling/abacus-develop
	```
- [Conda](https://anaconda.org/conda-forge/abacus) (📥 640K · ⏱️ 20.12.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 67 · 🔀 150 · 📦 160 · 📋 140 - 21% open · ⏱️ 15.04.2026):

	```
	git clone https://github.com/deepmodeling/dpdata
	```
- [PyPi](https://pypi.org/project/dpdata) (📥 69K / month):
	```
	pip install dpdata
	```
...
- [GitHub](https://github.com/deepmodeling/dpdispatcher) (👨‍💻 49 · 🔀 58 · 📦 70 · 📋 100 - 20% open · ⏱️ 10.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpdispatcher) (📥 4.2K / month):
	```
	pip install dpdispatcher
	```
- [Conda](https://anaconda.org/conda-forge/dpdispatcher) (📥 43K · ⏱️ 25.02.2026):
	```
...
- [GitHub](https://github.com/deepmodeling/dpgen) (👨‍💻 73 · 🔀 180 · 📥 2.1K · 📦 8 · 📋 340 - 11% open · ⏱️ 15.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpgen) (📥 590 / month):
	```
	pip install dpgen
	```
...
- [GitHub](https://github.com/deepmodeling/reacnetgenerator) (👨‍💻 19 · 🔀 46 · 📦 3 · 📋 130 - 6% open · ⏱️ 15.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/reacnetgenerator) (📥 1.4K / month):
	```
...
- [GitHub](https://github.com/deepmodeling/dargs) (👨‍💻 8 · 🔀 4 · 📦 160 · 📋 14 - 21% open · ⏱️ 24.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/dargs) (📥 78K / month):
	```
	pip install dargs
	```
...
<details><summary><b><a href="https://github.com/deepmodeling/jax-fem">JAX-FEM</a></b> (🥈15 ·  ⭐ 660 · 📈) - Differentiable Finite Element Method with JAX. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/jax-fem) (👨‍💻 17 · 🔀 110 · 📦 4 · 📋 72 - 36% open · ⏱️ 28.04.2026):

	```
	git clone https://github.com/deepmodeling/jax-fem
	```
- [PyPi](https://pypi.org/project/jax-fem) (📥 780 / month):
	```
	pip install jax-fem
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/DeePTB) (👨‍💻 15 · 🔀 30 · 📦 4 · 📋 60 - 33% open · ⏱️ 19.03.2026):
...
- [GitHub](https://github.com/deepmodeling/dpgui) (👨‍💻 4 · 🔀 5 · 📦 13 · ⏱️ 26.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/dpgui) (📥 62K / month):
	```
	pip install dpgui
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/deepmodeling_sphinx) (👨‍💻 8 · 🔀 6 · ⏱️ 12.11.2025):
	...
	```
- [PyPi](https://pypi.org/project/deepmodeling_sphinx) (📥 4.8K / month):
	```
...
- [GitHub](https://github.com/deepmodeling/dpti) (👨‍💻 17 · 🔀 23 · 📦 2 · 📋 10 - 90% open · ⏱️ 15.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpti) (📥 21 / month):
	```
	pip install dpti
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/fealpy) (👨‍💻 69 · 🔀 2 · ⏱️ 28.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/fealpy) (📥 280 / month):
	```
	pip install fealpy
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/AIS-Square) (👨‍💻 8 · 🔀 9 · 📋 6 - 83% open · ⏱️ 24.04.2026):
