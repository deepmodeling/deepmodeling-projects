...
- [GitHub](https://github.com/deepmodeling/deepmd-kit) (👨‍💻 84 · 🔀 560 · 📥 67K · 📦 45 · 📋 950 - 9% open · ⏱️ 21.01.2026):

	```
	git clone https://github.com/deepmodeling/deepmd-kit
	```
- [PyPi](https://pypi.org/project/deepmd-kit) (📥 9K / month):
	```
...
- [npm](https://www.npmjs.com/package/deepmd-kit) (📥 4 / month):
	...
	```
- [Docker Hub](https://hub.docker.com/r/deepmodeling/deepmd-kit) (📥 4.9K · ⭐ 1 · ⏱️ 27.12.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/abacus-develop) (👨‍💻 140 · 🔀 150 · 📋 2.5K - 7% open · ⏱️ 21.01.2026):
...
- [GitHub](https://github.com/deepmodeling/dpgen) (👨‍💻 73 · 🔀 180 · 📥 2.1K · 📦 8 · 📋 330 - 10% open · ⏱️ 20.01.2026):
...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 68 · 🔀 140 · 📦 150 · 📋 130 - 20% open · ⏱️ 20.01.2026):

	```
	git clone https://github.com/deepmodeling/dpdata
	```
- [PyPi](https://pypi.org/project/dpdata) (📥 42K / month):
	```
	pip install dpdata
	```
...
- [PyPi](https://pypi.org/project/dpdispatcher) (📥 2.5K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dpdispatcher) (📥 38K · ⏱️ 11.11.2025):
	```
...
- [PyPi](https://pypi.org/project/reacnetgenerator) (📥 1.9K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/reacnetgenerator) (📥 720K · ⏱️ 11.11.2025):
	```
...
<details><summary><b><a href="https://github.com/deepmodeling/DeePTB">DeePTB</a></b> (🥈16 ·  ⭐ 99) - DeePTB: A deep learning package for tight-binding Hamiltonian with ab initio accuracy. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/DeePTB) (👨‍💻 14 · 🔀 26 · 📦 4 · 📋 58 - 32% open · ⏱️ 11.01.2026):
...
<details><summary><b><a href="https://github.com/deepmodeling/deepflame-dev">DeepFlame</a></b> (🥈15 ·  ⭐ 200) - A deep learning empowered open-source platform for reacting flow simulations. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/deepflame-dev) (👨‍💻 29 · 🔀 72 · 📋 62 - 43% open · ⏱️ 13.01.2026):

	```
	git clone https://github.com/deepmodeling/deepflame-dev
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/jax-fem">JAX-FEM</a></b> (🥈14 ·  ⭐ 560 · 📉) - Differentiable Finite Element Method with JAX. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/jax-fem) (👨‍💻 17 · 🔀 92 · 📦 3 · 📋 69 - 34% open · ⏱️ 13.11.2025):
...
- [GitHub](https://github.com/deepmodeling/APEX) (👨‍💻 7 · 🔀 24 · 📦 4 · 📋 10 - 10% open · ⏱️ 10.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/apex-flow) (📥 320 / month):
	```
...
- [GitHub](https://github.com/deepmodeling/dpgui) (👨‍💻 4 · 🔀 5 · 📦 13 · ⏱️ 26.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/dpgui) (📥 39K / month):
	```
	pip install dpgui
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/dpti) (👨‍💻 17 · 🔀 22 · 📦 2 · 📋 10 - 90% open · ⏱️ 15.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/dpti) (📥 29 / month):
	```
	pip install dpti
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/fealpy) (👨‍💻 69 · 🔀 2 · ⏱️ 28.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/fealpy) (📥 830 / month):
	```
	pip install fealpy
	```
</details>
...
<details><summary><b><a href="https://github.com/deepmodeling/community">community</a></b> (🥉9 ·  ⭐ 90) - DeepModeling community content. <code>Unlicensed</code></summary>
...
- [GitHub](https://github.com/deepmodeling/fpop) (👨‍💻 4 · 🔀 12 · 📦 15 · ⏱️ 01.07.2024):
	...
	```
- [PyPi](https://pypi.org/project/fpop) (📥 99 / month):
	```
	pip install fpop
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/args) (👨‍💻 3 · 🔀 2 · 📦 5 · ⏱️ 15.12.2025):
	...
	```
- [npm](https://www.npmjs.com/package/@deepmodeling/args) (📥 34 / month):
	```
