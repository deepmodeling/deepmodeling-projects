...
- [GitHub](https://github.com/deepmodeling/deepmd-kit) (👨‍💻 86 · 🔀 600 · 📥 73K · 📦 54 · 📋 1K - 9% open · ⏱️ 25.06.2026):

	```
	git clone https://github.com/deepmodeling/deepmd-kit
	```
- [PyPi](https://pypi.org/project/deepmd-kit) (📥 9.4K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/deepmd-kit) (📥 2.9M · ⏱️ 07.06.2026):
	...
	```
- [npm](https://www.npmjs.com/package/deepmd-kit) (📥 40 / month):
	```
...
- [GitHub](https://github.com/deepmodeling/abacus-develop) (👨‍💻 160 · 🔀 240 · 📋 2.6K - 7% open · ⏱️ 25.06.2026):
...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 69 · 🔀 150 · 📦 160 · 📋 140 - 18% open · ⏱️ 25.06.2026):

	```
	git clone https://github.com/deepmodeling/dpdata
	```
- [PyPi](https://pypi.org/project/dpdata) (📥 94K / month):
	```
	pip install dpdata
	```
...
- [GitHub](https://github.com/deepmodeling/dpgen) (👨‍💻 74 · 🔀 180 · 📥 2.1K · 📦 8 · 📋 340 - 11% open · ⏱️ 17.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/dpgen) (📥 770 / month):
	```
	pip install dpgen
	```
...
- [GitHub](https://github.com/deepmodeling/dpdispatcher) (👨‍💻 50 · 🔀 58 · 📦 70 · 📋 100 - 19% open · ⏱️ 20.06.2026):
...
- [GitHub](https://github.com/deepmodeling/reacnetgenerator) (👨‍💻 20 · 🔀 45 · 📦 3 · 📋 130 - 6% open · ⏱️ 20.06.2026):
...
- [GitHub](https://github.com/deepmodeling/APEX) (👨‍💻 13 · 🔀 27 · 📦 4 · ⏱️ 08.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/apex-flow) (📥 530 / month):
	```
...
- [GitHub](https://github.com/deepmodeling/dpgen2) (👨‍💻 19 · 🔀 36 · 📦 6 · 📋 48 - 37% open · ⏱️ 23.06.2026):
...
<details><summary><b><a href="https://github.com/deepmodeling/jax-fem">JAX-FEM</a></b> (🥈17 ·  ⭐ 700 · 📈) - Differentiable Finite Element Method with JAX. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/deepmodeling/DeePTB) (👨‍💻 15 · 🔀 31 · 📦 4 · 📋 65 - 35% open · ⏱️ 25.06.2026):
...
- [GitHub](https://github.com/deepmodeling/dpgui) (👨‍💻 4 · 🔀 5 · 📦 15 · ⏱️ 26.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/dpgui) (📥 89K / month):
	```
	pip install dpgui
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/rid-kit) (👨‍💻 14 · 🔀 25 · 📥 150 · 📦 2 · 📋 5 - 40% open · ⏱️ 31.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/rid-kit) (📥 79 / month):
	```
	pip install rid-kit
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/dpti) (👨‍💻 17 · 🔀 23 · 📦 2 · 📋 10 - 90% open · ⏱️ 19.06.2026):

	```
	git clone https://github.com/deepmodeling/dpti
	```
- [PyPi](https://pypi.org/project/dpti) (📥 50 / month):
	```
	pip install dpti
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/deepmodeling_sphinx) (👨‍💻 8 · 🔀 6 · ⏱️ 31.05.2026):
	...
	```
- [PyPi](https://pypi.org/project/deepmodeling_sphinx) (📥 5.1K / month):
	```
...
- [GitHub](https://github.com/deepmodeling/fealpy) (👨‍💻 69 · 🔀 2 · ⏱️ 28.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/fealpy) (📥 550 / month):
	```
	pip install fealpy
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/blog) (👨‍💻 11 · 🔀 9 · ⏱️ 24.06.2026):
...
- [GitHub](https://github.com/deepmodeling/fpop) (👨‍💻 4 · 🔀 12 · 📦 18 · ⏱️ 01.07.2024):
	...
	```
- [PyPi](https://pypi.org/project/fpop) (📥 710 / month):
	```
	pip install fpop
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/AIS-Square) (👨‍💻 8 · 🔀 9 · 📋 6 - 83% open · ⏱️ 21.06.2026):
