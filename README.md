...
- [PyPi](https://pypi.org/project/deepmd-kit) (📥 1.3K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/deepmd-kit) (📥 480K · ⏱️ 07.04.2024):
	```
...
- [GitHub](https://github.com/deepmodeling/dpgen) (👨‍💻 64 · 🔀 170 · 📥 1.6K · 📦 5 · 📋 270 - 9% open · ⏱️ 10.04.2024):
...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 57 · 🔀 120 · 📦 120 · 📋 86 - 13% open · ⏱️ 03.04.2024):
...
- [GitHub](https://github.com/deepmodeling/abacus-develop) (👨‍💻 110 · 🔀 110 · 📋 1.3K - 14% open · ⏱️ 11.04.2024):

	```
	git clone https://github.com/deepmodeling/abacus-develop
	```
- [Conda](https://anaconda.org/conda-forge/abacus) (📥 22K · ⏱️ 28.03.2024):
	```
...
- [GitHub](https://github.com/deepmodeling/dpdispatcher) (👨‍💻 43 · 🔀 49 · 📦 47 · 📋 66 - 21% open · ⏱️ 25.03.2024):
...
- [Conda](https://anaconda.org/conda-forge/dpdispatcher) (📥 6.9K · ⏱️ 21.01.2024):
	...
	```
- [Docker Hub](https://hub.docker.com/r/dptechnology/dpdispatcher) (📥 93K · ⏱️ 21.01.2024):
	```
...
- [GitHub](https://github.com/deepmodeling/reacnetgenerator) (👨‍💻 18 · 🔀 32 · 📦 1 · 📋 120 - 4% open · ⏱️ 11.04.2024):

	```
	git clone https://github.com/deepmodeling/reacnetgenerator
	```
- [PyPi](https://pypi.org/project/reacnetgenerator) (📥 460 / month):
	```
...
- [GitHub](https://github.com/deepmodeling/dflow) (👨‍💻 22 · 🔀 23 · 📋 34 - 38% open · ⏱️ 07.04.2024):
...
- [Conda](https://anaconda.org/conda-forge/dflow):
	...
	```
- [Docker Hub](https://hub.docker.com/r/dptechnology/dflow) (📥 3.3K · ⏱️ 07.04.2024):
	```
...
- [GitHub](https://github.com/deepmodeling/dargs) (👨‍💻 7 · 🔀 2 · 📦 110 · 📋 7 - 14% open · ⏱️ 06.04.2024):

	```
	git clone https://github.com/deepmodeling/dargs
	```
- [PyPi](https://pypi.org/project/dargs) (📥 26K / month):
	```
	pip install dargs
	```
...
- [GitHub](https://github.com/deepmodeling/deepflame-dev) (👨‍💻 23 · 🔀 56 · 📋 43 - 34% open · ⏱️ 07.04.2024):
...
- [GitHub](https://github.com/deepmodeling/DMFF) (👨‍💻 14 · 🔀 40 · 📋 25 - 40% open · ⏱️ 12.01.2024):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dmff) (📥 180 · ⏱️ 06.01.2024):
	```
	conda install -c conda-forge dmff
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/DeePTB">DeePTB</a></b> (🥈14 ·  ⭐ 31 · 📈) - DeePTB: A deep learning package for tight-binding approach with ab initio accuracy. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/DeePTB) (👨‍💻 9 · 🔀 13 · 📋 21 - 9% open · ⏱️ 11.04.2024):
...
- [GitHub](https://github.com/deepmodeling/dpgen2) (👨‍💻 13 · 🔀 18 · 📦 1 · 📋 27 - 37% open · ⏱️ 09.04.2024):

	```
	git clone https://github.com/deepmodeling/dpgen2
	```
- [PyPi](https://pypi.org/project/dpgen2) (📥 28 / month):
	```
	pip install dpgen2
	```
- [Docker Hub](https://hub.docker.com/r/dptechnology/dpgen2) (📥 2.4K · ⏱️ 09.04.2024):
	```
	docker pull dptechnology/dpgen2
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/jax-fem">JAX-FEM</a></b> (🥈12 ·  ⭐ 130 · 🐣) - Differentiable Finite Element Method with JAX. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/jax-fem) (👨‍💻 7 · 🔀 26 · 📋 18 - 83% open · ⏱️ 21.03.2024):

	```
	git clone https://github.com/deepmodeling/jax-fem
	```
- [PyPi](https://pypi.org/project/jax-fem) (📥 88 / month):
	```
	pip install jax-fem
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/deepmodeling_sphinx) (👨‍💻 7 · 🔀 6 · ⏱️ 11.04.2024):
...
- [GitHub](https://github.com/deepmodeling/args) (👨‍💻 2 · 🔀 2 · 📦 5 · ⏱️ 08.04.2024):
...
- [GitHub](https://github.com/deepmodeling/dpti) (👨‍💻 15 · 🔀 19 · ⏱️ 08.04.2024):

	```
	git clone https://github.com/deepmodeling/dpti
	```
- [PyPi](https://pypi.org/project/dpti) (📥 18 / month):
	```
	pip install dpti
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/fealpy) (👨‍💻 57 · 🔀 1 · ⏱️ 29.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/fealpy) (📥 80 / month):
	```
	pip install fealpy
	```
</details>
...
<details><summary><b><a href="https://github.com/deepmodeling/tbplas">tbplas</a></b> (🥉7 ·  ⭐ 2 · 🐣) - Repository of TBPLaS (tight-binding package for large-scale simulation). <code>Unlicensed</code></summary>
...
- [GitHub](https://github.com/deepmodeling/blog) (👨‍💻 6 · 🔀 7 · ⏱️ 15.03.2024):

	```
	git clone https://github.com/deepmodeling/blog
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/AI4Science101">AI4Science101</a></b> (🥉6 ·  ⭐ 81 · 💤) - AI for Science. <code>Unlicensed</code></summary>
