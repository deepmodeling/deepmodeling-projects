...
- [GitHub](https://github.com/deepmodeling/deepmd-kit) (👨‍💻 84 · 🔀 570 · 📥 68K · 📦 46 · 📋 960 - 9% open · ⏱️ 12.02.2026):

	```
	git clone https://github.com/deepmodeling/deepmd-kit
	```
- [PyPi](https://pypi.org/project/deepmd-kit) (📥 13K / month):
	```
...
- [GitHub](https://github.com/deepmodeling/abacus-develop) (👨‍💻 140 · 🔀 150 · 📋 2.5K - 7% open · ⏱️ 10.02.2026):

	```
	git clone https://github.com/deepmodeling/abacus-develop
	```
- [Conda](https://anaconda.org/conda-forge/abacus) (📥 590K · ⏱️ 20.12.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/dpdata) (👨‍💻 68 · 🔀 150 · 📦 160 · 📋 130 - 20% open · ⏱️ 10.02.2026):

	```
	git clone https://github.com/deepmodeling/dpdata
	```
- [PyPi](https://pypi.org/project/dpdata) (📥 48K / month):
	```
	pip install dpdata
	```
...
- [GitHub](https://github.com/deepmodeling/dpgen) (👨‍💻 73 · 🔀 180 · 📥 2.1K · 📦 8 · 📋 340 - 11% open · ⏱️ 10.02.2026):
...
- [PyPi](https://pypi.org/project/dpgen) (📥 640 / month):
	...
	pip install dpgen
	```
- [Conda](https://anaconda.org/conda-forge/dpgen) (📥 49K · ⏱️ 07.08.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/dpdispatcher) (👨‍💻 48 · 🔀 56 · 📦 69 · 📋 97 - 18% open · ⏱️ 01.02.2026):

	```
	git clone https://github.com/deepmodeling/dpdispatcher
	```
- [PyPi](https://pypi.org/project/dpdispatcher) (📥 3.7K / month):
	```
...
- [GitHub](https://github.com/deepmodeling/reacnetgenerator) (👨‍💻 19 · 🔀 42 · 📦 3 · 📋 130 - 6% open · ⏱️ 05.02.2026):
...
- [GitHub](https://github.com/deepmodeling/deepflame-dev) (👨‍💻 30 · 🔀 72 · 📋 63 - 41% open · ⏱️ 28.01.2026):
...
- [GitHub](https://github.com/deepmodeling/dargs) (👨‍💻 7 · 🔀 3 · 📦 160 · 📋 9 - 22% open · ⏱️ 17.12.2025):
	...
	```
- [PyPi](https://pypi.org/project/dargs) (📥 60K / month):
	```
	pip install dargs
	```
- [Conda](https://anaconda.org/conda-forge/dargs) (📥 60K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/deepmodeling/DeePTB) (👨‍💻 15 · 🔀 26 · 📦 4 · 📋 58 - 31% open · ⏱️ 09.02.2026):

	```
	git clone https://github.com/deepmodeling/DeePTB
	```
- [PyPi](https://pypi.org/project/dptb) (📥 360 / month):
	```
	pip install dptb
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/dpgen2) (👨‍💻 19 · 🔀 35 · 📦 6 · 📋 46 - 39% open · ⏱️ 05.02.2026):
...
- [PyPi](https://pypi.org/project/dpgen2) (📥 79 / month):
	...
	pip install dpgen2
	```
- [Docker Hub](https://hub.docker.com/r/dptechnology/dpgen2) (📥 4.3K · ⏱️ 05.02.2026):
	```
	docker pull dptechnology/dpgen2
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/jax-fem">JAX-FEM</a></b> (🥈14 ·  ⭐ 580) - Differentiable Finite Element Method with JAX. <code><a href="http://bit.ly/2M0xdwT">GPL-3.0</a></code></summary>

- [GitHub](https://github.com/deepmodeling/jax-fem) (👨‍💻 17 · 🔀 93 · 📦 3 · 📋 69 - 33% open · ⏱️ 08.02.2026):

	```
	git clone https://github.com/deepmodeling/jax-fem
	```
- [PyPi](https://pypi.org/project/jax-fem) (📥 580 / month):
	```
	pip install jax-fem
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/APEX) (👨‍💻 7 · 🔀 24 · 📦 4 · 📋 10 - 10% open · ⏱️ 10.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/apex-flow) (📥 500 / month):
	```
...
- [GitHub](https://github.com/deepmodeling/rid-kit) (👨‍💻 14 · 🔀 25 · 📥 150 · 📦 2 · 📋 5 - 40% open · ⏱️ 31.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/rid-kit) (📥 54 / month):
	```
	pip install rid-kit
	```
</details>
...
<details><summary><b><a href="https://github.com/deepmodeling/dpti">dpti</a></b> (🥉10 ·  ⭐ 31 · 💤) - A Python Package to Automate Thermodynamic Integration Calculations for Free Energy. <code><a href="http://bit.ly/37RvQcA">LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/deepmodeling/fealpy) (👨‍💻 69 · 🔀 2 · ⏱️ 28.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/fealpy) (📥 340 / month):
	```
	pip install fealpy
	```
</details>
...
- [GitHub](https://github.com/deepmodeling/AIS-Square) (👨‍💻 8 · 🔀 8 · 📋 6 - 83% open · ⏱️ 30.01.2026):
...
- [GitHub](https://github.com/deepmodeling/fpop) (👨‍💻 4 · 🔀 12 · 📦 15 · ⏱️ 01.07.2024):
	...
	```
- [PyPi](https://pypi.org/project/fpop) (📥 180 / month):
	```
	pip install fpop
	```
</details>
<details><summary><b><a href="https://github.com/deepmodeling/community">community</a></b> (🥉8 ·  ⭐ 91) - DeepModeling community content. <code>Unlicensed</code></summary>
...
- [GitHub](https://github.com/deepmodeling/args) (👨‍💻 3 · 🔀 2 · 📦 5 · ⏱️ 15.12.2025):
	...
	```
- [npm](https://www.npmjs.com/package/@deepmodeling/args) (📥 73 / month):
	```
...
- [GitHub](https://github.com/deepmodeling/DeePDih) (🔀 3 · 📥 7 · ⏱️ 05.08.2025):
